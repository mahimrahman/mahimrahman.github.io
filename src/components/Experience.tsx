  ...
  const experiences = [
    {
      ...
      period: '2022 - Present',
      location: 'Remote',
      description: 'Architecting and developing enterprise-grade web applications with a focus on scalability, performance, and maintainability using modern JavaScript frameworks and cloud infrastructure.',
      achievements: [
        'Architected and deployed 10+ production-grade applications serving 100K+ users',
        'Reduced server response time by 60% through optimization and caching strategies',
    ...
    },
    {
      ...
      description: 'Developed responsive web applications and RESTful APIs while collaborating with cross-functional teams to deliver high-quality software solutions.',
      achievements: [
        'Built 15+ responsive web applications using React, Node.js, and PostgreSQL',
    ...
    },
    {
      ...
      period: '2019 - 2020',
      location: 'Remote',
      description: 'Focused on creating intuitive user interfaces and implementing pixel-perfect designs with emphasis on performance and accessibility.',
      achievements: [
        'Developed 20+ reusable React components improving development efficiency',
        'Improved website performance score from 65 to 95 on Google Lighthouse',
        'Collaborated with designers to implement responsive, accessible UI/UX',
      ],
    },
  ]
