  ...
  const projects = [
    {
      ...
      category: 'web',
      description: 'Full-featured e-commerce platform with cart management, payment gateway integration, and comprehensive admin dashboard for inventory control',
      image: '🛒',
    ...
    },
    {
      ...
      category: 'web',
      description: 'Enterprise collaboration platform featuring real-time updates, video conferencing, and document sharing capabilities',
      image: '📋',
    ...
    },
    {
      ...
      category: 'web',
      description: 'Interactive e-learning platform with video courses, quizzes, progress tracking, and certificate generation',
      image: '📚',
    ...
    },
    {
      ...
      category: 'web',
      description: 'AI-powered content generation tool for creating marketing copy, blog posts, and social media content using GPT integration',
      image: '🤖',
